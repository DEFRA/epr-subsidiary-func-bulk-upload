    ...
    : IBulkSubsidiaryProcessor
{
    ...
    private async Task ReportCompanies(IEnumerable<LinkOrganisationModel> linkSubsidiaries, UserRequestModel userRequestModel, string errorMessage, int errorNumber)
    {
